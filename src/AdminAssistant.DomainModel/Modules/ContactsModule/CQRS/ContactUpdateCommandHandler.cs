...
internal sealed class ContactUpdateCommandHandler : RequestHandlerBase<ContactUpdateCommand, Result<Contact>>
{
    private readonly IContactRepository _contactRepository;
    private readonly IContactValidator _contactValidator;

    public ContactUpdateCommandHandler(ILoggingProvider loggingProvider, IContactRepository contactRepository, IContactValidator contactValidator)
