...
namespace AdminAssistant.Infra.DAL.EntityFramework.Migrations
{
    ...
    [Migration("20200723095338_UseSchemas")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.AuditEntity", b =>
                {
                    b.Property<int>("AuditID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.CompanyEntity", b =>
                {
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.CurrencyEntity", b =>
                {
                    b.Property<int>("CurrencyID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.OwnerEntity", b =>
                {
                    b.Property<int>("OwnerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.PermissionEntity", b =>
                {
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.PersonalDetailsEntity", b =>
                {
                    b.Property<int>("PersonalDetailsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.SettingEntity", b =>
                {
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfileEntity", b =>
                {
                    b.Property<int>("UserProfileID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfilePermissionEntity", b =>
                {
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfileSettingEntity", b =>
                {
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.Accounts.BankAccountEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.AuditEntity", "Audit")
                        .WithOne("BankAccount")
                        .HasForeignKey("AdminAssistant.DAL.EntityFramework.Model.Accounts.BankAccountEntity", "AuditID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.CurrencyEntity", "Currency")
                        .WithMany()
                        .HasForeignKey("CurrencyID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.OwnerEntity", "Owner")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.CompanyEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.AuditEntity", "Audit")
                        .WithOne("Company")
                        .HasForeignKey("AdminAssistant.DAL.EntityFramework.Model.CompanyEntity", "AuditID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.UserProfileEntity", "UserProfile")
                        .WithMany("Companies")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.OwnerEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.CompanyEntity", "Company")
                        .WithMany("Owns")
                        .HasForeignKey("CompanyID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.PersonalDetailsEntity", "PersonalDetails")
                        .WithMany("Owns")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.PersonalDetailsEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.AuditEntity", "Audit")
                        ...
                        .HasForeignKey("AdminAssistant.DAL.EntityFramework.Model.PersonalDetailsEntity", "AuditID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.UserProfileEntity", "UserProfile")
                        .WithOne("PersonalDetails")
                        .HasForeignKey("AdminAssistant.DAL.EntityFramework.Model.PersonalDetailsEntity", "UserProfileID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfileEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.AuditEntity", "Audit")
                        .WithOne("UserProfile")
                        .HasForeignKey("AdminAssistant.DAL.EntityFramework.Model.UserProfileEntity", "AuditID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfilePermissionEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.PermissionEntity", "Permission")
            ...
            modelBuilder.Entity("AdminAssistant.DAL.EntityFramework.Model.UserProfileSettingEntity", b =>
                {
                    b.HasOne("AdminAssistant.DAL.EntityFramework.Model.SettingEntity", "Setting")
