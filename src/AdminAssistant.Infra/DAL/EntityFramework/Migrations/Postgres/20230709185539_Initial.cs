...
namespace AdminAssistant.Infra.DAL.EntityFramework.Migrations.Postgres
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactAddress_Audit_AuditID",
                        column: x => x.AuditID,
                        principalSchema: "Core",
                        principalTable: "Audit",
                        principalColumn: "AuditID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactAddress_AuditID",
                schema: "Contacts",
